...
final class FairyVariantUITests: XCTestCase {
    ...
    /// Les quatre tuiles (Chess960 + les trois variantes Fairy-Stockfish)
    /// doivent toutes exister — la vérification la plus simple qu'aucune ne
    /// s'est perdue en route depuis la grille.
    @MainActor
    func testHubShowsAllFourVariantTiles() throws {
        let app = XCUIApplication()
        openVariantsHub(app)

        for identifier in ["variant_chess960", "variant_kingofthehill", "variant_3check", "variant_horde"] {
