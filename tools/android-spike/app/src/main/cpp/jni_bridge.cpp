...
Java_com_chesslab_spike_Stockfish_nativeStart(JNIEnv *env, jobject, jstring path) {
...
Java_com_chesslab_spike_Stockfish_nativeSend(JNIEnv *env, jobject, jstring command) {
...
Java_com_chesslab_spike_Stockfish_nativeReadLine(JNIEnv *env, jobject) {
    std::string line;
    {
...
JNIEXPORT void JNICALL
Java_com_chesslab_spike_Stockfish_nativeStop(JNIEnv *, jobject) {
    cstockfish_stop();
    {
        std::lock_guard<std::mutex> lock(gMutex);
        gClosed = true;
...
Java_com_chesslab_spike_Stockfish_nativeIsRunning(JNIEnv *, jobject) {
